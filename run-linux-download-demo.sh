...
# and run the browser-initiated downloads demo (WebViewDownloadDemo).
#
# Exercises HTTP responses the engine classifies as downloads
# (Content-Disposition: attachment) across three handler modes
# (Default ~/Downloads policy, Custom temp-dir routing, Drop / null
# = cancel all).  See demos/WebViewDownloadDemo/README.md for the
# AC-mapped manual test checklist.
#
...
#
# STORY-005-001 requires AC verification in BOTH modes; run the script
