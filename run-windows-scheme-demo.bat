@echo off
REM ============================================================================
REM run-windows-scheme-demo.bat
REM
REM One-shot build & launch of WebViewSchemeDemo on Windows (Canvas 30).  Builds
...
if "%JAVA_HOME%"=="" (
    ...
    echo     run-windows-scheme-demo.bat
    echo.
    exit /b 1
)
...
REM ---------------------------------------------------------------------------
REM 7. Compile and launch the scheme demo
REM ---------------------------------------------------------------------------
set "DEMO_DIR=%REPO_DIR%\demos\WebViewSchemeDemo"
