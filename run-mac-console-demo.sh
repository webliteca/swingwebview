...
# the console + DevTools Swing demo.  No Ant required.
#
# Usage:    ./run-mac-console-demo.sh
# Override: JAVA_HOME=/path/to/jdk ./run-mac-console-demo.sh
#
set -e
...
# ---------------------------------------------------------------------------
# 5. Compile and run the console demo
# ---------------------------------------------------------------------------
