...
# demo:// scheme, answered in Java, in the heavyweight component, the
# supported macOS mode.  See demos/WebViewSchemeDemo/README.md for the
# AC-mapped checklist.
#
...
# ---------------------------------------------------------------------------
# 5. Compile and run the scheme demo
# ---------------------------------------------------------------------------
DEMO_DIR="$REPO_DIR/demos/WebViewSchemeDemo"
DEMO_CLASSES="$BUILD_DIR/classes-scheme-demo"
mkdir -p "$DEMO_CLASSES"
echo "Compiling demo ..."
"$JAVAC" -d "$DEMO_CLASSES" \
    -classpath "$WV_JAR" \
    "$DEMO_DIR/src/ca/weblite/webview/demos/WebViewSchemeDemo.java"
