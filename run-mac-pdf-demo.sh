...
# margins) from the heavyweight component, the supported macOS mode.  See
# demos/WebViewPdfDemo/README.md for the AC-mapped checklist.
#
# Usage:    ./run-mac-pdf-demo.sh
#           PDFDEMO_AUTO=1 ./run-mac-pdf-demo.sh   # print, check, exit (0 = passed)
# Override: JAVA_HOME=/path/to/jdk ./run-mac-pdf-demo.sh
#
set -e
...
# ---------------------------------------------------------------------------
# 5. Compile and run the PDF demo
# ---------------------------------------------------------------------------
