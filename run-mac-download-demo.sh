...
# = cancel all).  Requires macOS 11.3 or later; older macOS lacks
# WKDownload and downloads silently drop.  See
# demos/WebViewDownloadDemo/README.md for the AC-mapped manual test
# checklist.
#
# Usage:    ./run-mac-download-demo.sh
# Override: JAVA_HOME=/path/to/jdk ./run-mac-download-demo.sh
#
set -e
...
# ---------------------------------------------------------------------------
# 5. Compile and run the download demo
# ---------------------------------------------------------------------------
